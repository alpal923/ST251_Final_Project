...
```{r prior_distribution_graphed, echo=FALSE, fig.height=3, fig.width=7}
...
```{r post_lucas, echo=FALSE, fig.height=3, fig.width=7, include=FALSE}
par(mfrow = c(1, 2))
...
```{r post_disney, echo=FALSE, fig.height=3, fig.width=7, include=FALSE}
par(mfrow = c(1, 2))
