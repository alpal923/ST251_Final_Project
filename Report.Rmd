...
```{r post_lucas, echo=FALSE, fig.height=3, fig.width=7, include=TRUE, warning=FALSE}
par(mfrow = c(1, 2))
...
```{r post_disney, echo=FALSE, fig.height=3, fig.width=7, include=TRUE, warning=FALSE}
par(mfrow = c(1, 2))
...
```{r post diff, echo=FALSE, fig.height=4, fig.width=9, include=TRUE, warning=FALSE}
